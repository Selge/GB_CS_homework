...
int max_2 = num_e > num_d ? num_e : num_d; // понимаю, что использование тернарного оператора скорее всего не ожидалось (не совсем по программе),
max_2 = max_2 > num_f ? max_2 : num_f; // но мне же нужно учиться :)
